# Getting Started with NodeCopier

Welcome to **NodeCopier**, the official Node.js client library for MetaRPC's ultra-low latency Trade Copier engine.

## Installation

Install NodeCopier using your language's package manager:
...
2. **Manager Key (`manager_key`)**: Optional. Identifies the copier manager role. If omitted, defaults to `user_key`.
