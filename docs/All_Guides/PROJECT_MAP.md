...
This document provides a comprehensive architectural map of **NodeCopier** and the MetaRPC Trade Copier engine.
...
```mermaid
flowchart TD
    subgraph ClientLayer ["Client Application Layer (Node.js)"]
